    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full">
            ...
            <div class="text-center mb-8">
                <h1 class="font-display text-4xl font-bold text-[var(--fg)] mb-2">New Password</h1>
                <p class="text-[var(--fg-muted)] text-lg">Choose a secure password</p>
            </div>
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-3 flex items-center gap-3 text-sm text-[var(--fg-muted)]">
                            <input id="show-password-reset" type="checkbox" data-show-password-target="password"
                                class="h-4 w-4 rounded border-[#8a8a8a] bg-[#1a1a1a] text-[#c9a77c] focus:ring-[#c9a77c]" />
                            <label for="show-password-reset" class="select-none">Show Password</label>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-3 flex items-center gap-3 text-sm text-[var(--fg-muted)]">
                            <input id="show-password-reset-confirm" type="checkbox" data-show-password-target="password_confirmation"
                                class="h-4 w-4 rounded border-[#8a8a8a] bg-[#1a1a1a] text-[#c9a77c] focus:ring-[#c9a77c]" />
                            <label for="show-password-reset-confirm" class="select-none">Show Password</label>
                        </div>
